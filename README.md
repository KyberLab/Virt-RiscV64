# KyberLab Virt-RiscV64

[中文版本](README_zh.md) | English Version

## Project Overview

KyberLab Virt-RiscV64 is a virtual development platform for RiscV64 architecture:
...
```bash
git clone https://github.com/KyberLab/Virt-RiscV64.git
cd Virt-RiscV64
...
# Build Virt-RiscV64 virtual workbench image
make build_virt-RiscV64

# Start Virt-RiscV64 virtual workbench environment and enter interactive shell
make run_virt-RiscV64
```
